...
--declare & set counter
Declare @counter1 int set @counter1 = 1

--declare cursor name
declare printdata cursor
for select id, firstname, middlename, lastname from s1.candidates
...
print 'id' + char(9)+
'firstname' + char(9)+char(9) +
'lastname' print 'id' + char(9)
end
