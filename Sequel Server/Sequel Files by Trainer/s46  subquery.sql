----------------------------------------------------------------------------
--	sub query : external and internal query
----------------------------------------------------------------------------
use db1;
go
----------------------------------------------------------------------------
create table s1.emp25(	empid 		int 		primary key,
			empname 	varchar(10) 	not null,
			empage 		int,
			projectid 	int );
go
----------------------------------------------------------------------------
create table s1.project1(	projectid 	int 		primary key,
				projectname 	varchar(10),
				projectcity 	varchar(10) 	not null,
				projectcost 	int 		not null);
go
----------------------------------------------------------------------------
insert into s1.emp25 values		
			(101,'sunil',24,804) , 
			(102,'rajesh',26,801) , 
			(103,'anil',25,801),
			(104,'suresh',22,805);
go
----------------------------------------------------------------------------
insert into s1.project1 values	
...
----------------------------------------------------------------------------
select projectid from s1.project1 where projectcity = 'pune';
go
----------------------------------------------------------------------------
--	projectid
----------------------------------------------------------------------------
...
--	803
----------------------------------------------------------------------------
select empid, empname, projectid from s1.emp25 
where projectid in 
			( 	select projectid from s1.project1 
...
go
----------------------------------------------------------------------------
-- null output of the above query ?
----------------------------------------------------------------------------
select empid, empname, projectid from s1.emp25 
where projectid in 
			( 	select projectid from s1.project1 
